...
- Изменение данных по городу (возможно изменение только полей: Численность населения, Наличие метро) - изменить можно все данные, ограничения на поля не успел сделать. http://localhost:8080/attractions/{id}
